...
public class Libreria {
   ...
   public static final HashMap<Rol, ArrayList<Usuario>> usuarios = new HashMap<Rol, ArrayList<Usuario>>();
    ...
    public void registrarCliente() {
      Usuarios.Cliente.registrarCliente();
    }
   ...
   Usuarios.Asistente.registrarAsistente();
    }



public void registrarGerente() {
Usuarios.Gerente.registrarGerente();
}
 ...
 Usuarios.Cliente.mostrarClientes();
    }

    public void mostrarAsistentes() {
    Usuarios.Asistente.mostrarAsistentes();
    }
    

    public  void mostrarGerentes() {
       Usuarios.Gerente.mostrarGerentes(); 
    }
