...
import usuarios.utils.EmployeeUtils;
...
public class Administrador extends Usuario implements EmployeeUtils {
    private Double sueldo;
    private String RFC;
    private String INE;

    public Administrador(String nombre, String apellido, String telefono,
                         Double sueldo, String RFC, String INE, String userName, String contraseña, String fechaNacimiento) {
        super(nombre, apellido, telefono, Rol.GERENTE, userName, contraseña, fechaNacimiento);
        this.sueldo = sueldo;
        this.RFC = RFC;
        this.INE = INE;
    }
    ...
    public static void registrarGerente() {
        ...
        String fechaNacimiento = datosComun.get(6);
        ...
        Asistente newManager = new Asistente (nameManager, apellidoManager,
                ...
                usernameManager, passwordManager, fechaNacimiento);
    ...
    public static void eliminarGerente() {
        ...
        if (DatosComun.isGerente(userToBeRemovedManager)) {
