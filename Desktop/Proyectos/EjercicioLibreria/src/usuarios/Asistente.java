...
public class Asistente extends Usuario implements EmployeeUtils {
    ...
    public Asistente(String nombre, String apellido, String telefono,
        ...
        super(nombre, apellido, telefono, Rol.ASISTENTE, userName, contraseña, fechaNacimiento);
    ...
    public static void registrarAsistente() {
        ...
        Asistente newAsistente = new Asistente (nameAssistan, apellido,
                ...
                usernameAsistente, passwordAsistente, fechaNacimiento);
