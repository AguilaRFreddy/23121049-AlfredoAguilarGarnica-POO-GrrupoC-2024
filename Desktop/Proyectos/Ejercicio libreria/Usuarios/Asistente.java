...
public class Asistente extends Usuario implements EmpleadoUtils {
    ...
    public Asistente(String nombre, String apellido, String telefono, double sueldo, String rfc, String nombreUsuario,
            String contrasena, String fechaNacimiento) {
    ...
    public static void registrarAsistente() {
        ...
        String fechaNacimientoString = datosComun.get(5);
        ...
        Asistente asistente = new Asistente(nombre, apellido, telefono, sueldo, rfc.toUpperCase(), nombreUsuario,
                contraseña, fechaNacimientoString);

        if (!Libreria.usuarios.containsKey(Rol.ASISTENTE)) {
            Libreria.usuarios.put(Rol.ASISTENTE, new ArrayList<Usuario>());
            // eso va a entrar cuando la llave no
            // exista, o sea que el hash este vacio, si
            // no lo va a ignorar (en la segunda vez)
        }
