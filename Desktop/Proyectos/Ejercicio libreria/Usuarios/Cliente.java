...
public class Cliente extends Usuario {
    ...
    public String toString() { // Aqui lo estamos sobreescribiendogracias al override y con eso el programa
    ...
    public static void registrarCliente() {
        ...
        if (!Libreria.usuarios.containsKey(Rol.CLIENTE)) {
            ...
            // eso va a entrar cuando la llave no exista,
            // o sea que el hash este vacio, si no lo va a
            // ignorar (en la segunda vez)
